...
from .clip import MCLIPEncoderOnnx, OpenCLIPEncoderOnnx
    ...
    match model_type:
        case ModelType.CLIP:
            if is_openclip(model_name):
                return OpenCLIPEncoderOnnx(model_name, **model_kwargs)
            elif is_mclip(model_name):
                return MCLIPEncoderOnnx(model_name, **model_kwargs)
